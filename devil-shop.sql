...
-- Database: `devil-shop`
--
CREATE DATABASE IF NOT EXISTS `devil-shop` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `devil-shop`;
...
INSERT INTO `shopping-cart` (`id`, `user_id`, `shopping_date`, `total_amount`) VALUES
(2, 3, '0000-00-00', 0.00),
(3, 5, '0000-00-00', 0.00);
...
(5, 'dsfgy', 'hgj,kgztr54', '12345', 'fake@email.com', '21435r', '1243rt', 'ewdfsvxcy', 'Groningen', 'ASDFXGCHVBMN,');
...
('root', '[{\"db\":\"devil-shop\",\"table\":\"category\"},{\"db\":\"devil-shop\",\"table\":\"shopping-cart\"},{\"db\":\"devil-shop\",\"table\":\"users\"},{\"db\":\"devil-shop\",\"table\":\"products\"},{\"db\":\"devil-shop\",\"table\":\"cart-items\"},{\"db\":\"devil-shop\",\"table\":\"catagory\"}]');
...
('root', 'devil-shop', 'users', '{\"sorted_col\":\"`users`.`id` ASC\"}', '2025-05-16 09:14:54');
...
('root', '2025-05-20 07:25:35', '{\"Console\\/Mode\":\"collapse\"}');
